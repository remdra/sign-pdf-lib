...
const _paths = {
  ...
  imagePlaceholderPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-17', 'placeholder-image.pdf'),
  ...
  imageTwiceSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-17', 'signed-twice-image.pdf'),
