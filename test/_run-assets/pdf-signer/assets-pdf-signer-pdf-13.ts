...
const _paths = {
  ...
  fieldPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field.pdf'),
  positiveCoordinatesPlaceholderPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'placeholder-positive-coordinates.pdf'),
  positiveCoordinatesFieldPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-positive-coordinates.pdf'),
  negativeCoordinatesPlaceholderPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'placeholder-negative-coordinates.pdf'),
  negativeCoordinatesFieldPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-negative-coordinates.pdf'),
  differentPlaceholderPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'placeholder-different.pdf'),
  differentFieldPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-different.pdf'),
  ...
  textsPlaceholderPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'placeholder-texts.pdf'),
  textsAndBackgroundPlaceholderPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'placeholder-texts-and-background.pdf'),
  ...
  signedVisualPdf:      path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'visual-signed.pdf'),
  positiveCoordinatesSignedVisualPdf:      path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'visual-signed-positive-coordinates.pdf'),
  negativeCoordinatesSignedVisualPdf:      path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'visual-signed-negative-coordinates.pdf'),

  jpgImageTwiceSignedVisualPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'visual-signed-twice-jpg-image.pdf'),
  pngImageTwiceSignedVisualPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'visual-signed-twice-png-image.pdf'),

  fieldSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-signed.pdf'),
  noBackgroundFieldSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-signed-no-background.pdf'),
  noTextsFieldSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-signed-no-texts.pdf'),
  noVisualFieldSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-signed-no-visual.pdf'),

  specifiedFieldSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-signed-specified-field.pdf'),
  jpgImageFieldSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-signed-jpg-image.pdf'),
  pngImageFieldSignedPdf: path.join('test', '_assets', 'pdf-signer', 'pdf-13', 'field-signed-png-image.pdf')
};
