...
const _paths = {
    p12Certificate: path.join('test', '_assets', 'signature-computer', 'settings', 'certificate.p12'),
    pemCertificate: path.join('test', '_assets', 'signature-computer', 'settings', 'certificate.pem'),
