...
import { SignatureText } from '../models';
import { PlaceholderParameters, SignatureFieldParameters, SignatureParameters, SignaturePlaceholderForFieldParameters, SignatureVisualParametersEx } from '../models/parameters';
...
export class SignDocument {
    ...
    async addPlaceholderForFieldAsync(placeholderParams: SignaturePlaceholderForFieldParameters): Promise<void> {
        const placeholderRef = this.addPlaceholder(placeholderParams.info, placeholderParams.placeholder);
